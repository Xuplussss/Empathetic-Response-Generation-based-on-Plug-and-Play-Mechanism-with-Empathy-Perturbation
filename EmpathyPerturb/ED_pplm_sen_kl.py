...
def perturb_hidden(
    ...
    for i in range(num_iterations):
        ...
        if loss_type == PPLM_BOW or loss_type == PPLM_BOW_DISCRIM:
            ...
            # # # weight rel
            loss_rel = torch.mul(loss_rel, 0, out=None)
        ...
        if loss_type == PPLM_DISCRIM or loss_type == PPLM_BOW_DISCRIM:
            ...
            # # # weight val
            val_loss = torch.mul(val_loss, 0, out=None)
            ### ===detection model end===
...
def run_pplm_example(
    ...
    if out_dir != None:
        ...
        file_pert = open('output/' + out_dir + '/perturb_kl.txt', 'w+', encoding='utf-8')
        file_loss = open('output/' + out_dir + '/loss_record_perturb_kl.txt', 'w+', encoding='utf-8')
    else:
        file_pert = open('output/perturb_kl.txt', 'w+', encoding='utf-8')
        file_loss = open('output/loss_record_perturb_kl.txt', 'w+', encoding='utf-8')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--stepsize", type=float, default=0.17)
    ...
    parser.add_argument("--kl_scale", type=float, default=1.00)
