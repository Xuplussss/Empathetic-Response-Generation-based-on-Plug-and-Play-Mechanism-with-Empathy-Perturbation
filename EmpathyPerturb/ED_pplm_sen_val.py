...
def run_pplm_example(
    ...
    if out_dir != None:
        ...
        file_pert = open('output/' + out_dir + '/perturb_val.txt', 'w+', encoding='utf-8')
        file_loss = open('output/' + out_dir + '/loss_record_perturb_val.txt', 'w+', encoding='utf-8')
    else:
        file_pert = open('output/perturb_val.txt', 'w+', encoding='utf-8')
        file_loss = open('output/loss_record_perturb_val.txt', 'w+', encoding='utf-8')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--stepsize", type=float, default=0.16)
