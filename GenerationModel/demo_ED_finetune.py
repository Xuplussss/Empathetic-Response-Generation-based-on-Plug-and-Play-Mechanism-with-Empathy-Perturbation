...
### ===change to ED data===
data_path = os.path.join(DATA_FOLDER, 'ED_train_v0.tsv')    # fine_tune 使用的dataset
### ===change to ED data===
...
args = [
    ...
    '--eval_input_file', './data/ED_valid.tsv',   # dummy test data -> 要fine_tune的Data: ED valid set
    '--output_dir', os.path.join(MODEL_FOLDER, 'output_model'),
    '--seed', '42',
    '--max_seq_length', '128',
    '--train_batch_size', '16', #for 10 Gb memory need to adjust to 16 (origin:32)
    '--gradient_accumulation_steps', '8',
    '--eval_batch_size', '16',  #for 10 Gb memory need to adjust to 16 (origin:64)
    '--learning_rate', '1e-5',
